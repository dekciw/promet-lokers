...
- [ ] **CATALOG-02**: Администратор может фильтровать шкафы по серии (ML / LS / Все)
- [ ] **CATALOG-03**: Администратор может искать шкаф по названию (текстовый поиск)
- [ ] **CATALOG-04**: При клике на карточку открывается попап редактирования
- [ ] **CATALOG-05**: В попапе редактируются все поля: порядковый номер, название, артикул, серия, цена (basePrice), высота, ширина, глубина, толщина корпуса, толщина двери, количество замков, количество дверей, вес, цена с НДС (cpBezNDS)
...
| CATALOG-02 | Phase 8 | Pending |
| CATALOG-03 | Phase 8 | Pending |
| CATALOG-04 | Phase 8 | Pending |
| CATALOG-05 | Phase 8 | Pending |
